...
You can also use the standalone build by including `dist/react-formatted-amount.js` i n your page. If you use this, make sure you have already included React, and it is available as a global variable.
...
<ReactFormattedAmount>Example</ReactFormattedAmount>
```
